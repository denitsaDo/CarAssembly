...
building time for a Car?*/
    public static void main(String[] args) throws InterruptedException {
        ...
        EngineAndFrameMaker t1 = new EngineAndFrameMaker();
        SeatMaker t2 = new SeatMaker();
        TyreMakerUPGRADED t3 = new TyreMakerUPGRADED();
        ...
        System.out.println("Car was produced. Totoal time for car production is: " + (end-start)/1000 + " seconds");
    }
}
